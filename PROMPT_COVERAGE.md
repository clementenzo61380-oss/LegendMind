...
| **3 — `/setup` + `/premium` + `/accounts`** | Complet | `/setup` vérifie `league.id == 29000022`, active essai 7 j, **présente un Select Légende I/II/III** (Avril 2026 refonte). `/premium` ouvre Checkout. `/accounts` liste/retire avec tier affiché (limite 1 Free / 3 Premium). |
